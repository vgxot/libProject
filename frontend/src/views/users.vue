      ...
      <transition name="sort-block">
        <div v-if="openSort" class="sort-block">
          <div class="button-block">
            ...
            <app-button @click="Active500" class="button-choice" :class="{ active: isActive500 }">500</app-button>
            <app-button @click="Active1000" class="button-choice" :class="{ active: isActive1000 }">1000</app-button>
          </div>
