    ...
    <div class="block-1">
      <div class="user-header">
        <div class="background-block">
          <img class="background-img" :src="'http://127.0.0.1:3000/img/background/' + user.background_link" alt="">
        </div>
        <div class="user-info-block">
          <div class="info-flex-block">
            <img class="user-img" :src="'http://127.0.0.1:3000/img/user/' + user.avatar_link" alt="">
