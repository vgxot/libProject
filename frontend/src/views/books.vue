    ...
    <div class="books">
        <form @submit.prevent class="search-block">
            <div class="query-block">
                <app-button class="categories-button">Категории
                ...
                <app-button @click="openSort = !openSort" class="open-sort-block">Фильтр
            ...
            <transition name="sort-block">
                <div v-if="openSort" class="sort-block">
                    <div class="button-block">
                        <app-button @click="Active30" class="button-choice" :class="{ active: isActive30 }">30</app-button>
                        <app-button @click="Active50" class="button-choice" :class="{ active: isActive50 }">50</app-button>
                        <app-button @click="Active100" class="button-choice" :class="{ active: isActive100 }">100</app-button>
                    </div>
                    <div class="count-elements">
                      <p class="count-text">найдено элементов: <span class="count-text-color">{{ booksCount - 1 }}</span></p>
                    </div>
                    <app-button @click="sortFunction" class="sort-button">
                    ...
                    <app-button class="sort-search-button"></app-button>
                </div>
            </transition>
        </form>
...
import ChoiceButton from "@/components/UI/buttons/choice-button.vue";
